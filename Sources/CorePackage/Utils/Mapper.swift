...
extension FavoriteGameEntity {
    internal func toGameListItemModel() -> GameListItemModel {
        return GameListItemModel(
            id: self.id,
            slug: "",
            name: self.title,
...
public extension GameListItemModel {
    internal func toFavoriteGameEntity(model: GameListItemModel) -> FavoriteGameEntity {
